...
(defmacro custom-theme-set-common (name colors &rest body)
  `(let* ,colors
     ...
     (custom-theme-set-faces
      ...
      `(header-line ((,class (:background ,bg6))))
      ...
      `(cider-error-highlight-face ((,class ())))
      `(cider-warning-highlight-face ((,class ())))
      ...
      `(centaur-tabs-unselected ((,class (:background ,bg6 :foreground ,bg3 :box (:line-width 5 :color ,bg6 :style nil) :font ,local-menu-font-face))))
     ...
     (custom-theme-set-variables
      ,name
      `(custom-theme-face-fg1 ,fg1 t)
      `(custom-theme-face-fg2 ,fg2 t)
      `(custom-theme-face-fg3 ,fg3 t)
      `(custom-theme-face-fg4 ,fg4 t)
      `(custom-theme-face-fg5 ,fg5 t)
      `(custom-theme-face-fg6 ,fg6 t)
      `(custom-theme-face-bg1 ,bg1 t)
      `(custom-theme-face-bg2 ,bg2 t)
      `(custom-theme-face-bg3 ,bg3 t)
      `(custom-theme-face-bg4 ,bg4 t)
      `(custom-theme-face-bg5 ,bg5 t)
      `(custom-theme-face-bg6 ,bg6 t)
      `(custom-theme-face-bg7 ,bg7 t)
      `(custom-theme-face-red ,red t)
      `(custom-theme-face-green ,green t)
      `(custom-theme-face-yellow ,yellow t)
      `(custom-theme-face-blue ,blue t)
      `(custom-theme-face-magenta ,magenta t)
      `(custom-theme-face-cyan ,cyan t)
      `(custom-theme-face-builtin ,builtin t)
      `(custom-theme-face-keyword ,keyword t)
      `(custom-theme-face-const ,const t)
      `(custom-theme-face-func ,func t)
      `(custom-theme-face-str ,str t)
      `(custom-theme-face-type ,type t)
      `(custom-theme-face-var ,var t)
      `(custom-theme-face-tag ,tag t)
      `(custom-theme-face-border ,border t)
      `(custom-theme-face-match ,match t)
      `(custom-theme-face-success ,success t)
      `(custom-theme-face-success2 ,success2 t)
      `(custom-theme-face-info ,info t)
      `(custom-theme-face-error ,error t)
      `(custom-theme-face-error2 ,error2 t)
      `(custom-theme-face-warning ,warning t)
      `(custom-theme-face-delim ,delim t)
      `(custom-theme-face-ml-border ,ml-border t)
