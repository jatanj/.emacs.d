...
(defmacro custom-theme-set-common (name colors &rest body)
  `(let* ,colors
     ...
     (custom-theme-set-faces
      ...
      `(doom-neotree-hidden-file-face ((,class (:foreground ,bg5))))
      ...
      `(neo-dir-link-face ((,class (:foreground ,tag))))
      ...
      `(org-level-1 ((,class (:foreground ,type :bold t :height 1.2))))
      `(org-level-2 ((,class (:foreground ,success :bold t :height 1.1))))
      ...
      `(tabbar-selected ((,class (:background ,bg1 :foreground ,fg5 :weight bold :box (:line-width 5 :color ,bg1 :style nil)))))
