 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'custom-dark
    ...
    `(font-lock-constant-face ((,class (:foreground ,const))))
        ...
        `(region ((,class (:background ,"#555555" :foreground ,"#ffffff"))))
        `(highlight ((,class (:foreground ,"#ffffff" :background ,success))))
    ...
    `(cursor ((,class (:background ,"#ffffff"))))
        ...
        `(isearch ((,class (:bold t :foreground ,fg1 :background ,success))))
    ...
    `(slime-repl-inputed-output-face ((,class (:foreground ,type))))
        ...
        `(term-color-red ((,class (:foreground ,"#8c4848" :background ,bg1))))
        `(term-color-green ((,class (:foreground ,"#639743" :background ,bg1))))
        `(term-color-yellow ((,class (:foreground ,"638eA6" :background ,bg1))))
        `(term-color-magenta ((,class (:foreground ,"#646496" :background ,bg1))))
        `(term-color-cyan ((,class (:foreground ,"#387c98" :background ,bg1))))
        `(term-color-white ((,class (:foreground ,"#ffffff" :background ,bg1))))
