 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'custom-dark
    ...
    `(slime-repl-inputed-output-face ((,class (:foreground ,type))))
        ...
        `(term-color-green ((,class (:foreground ,success3 :background ,bg1))))
        `(term-color-yellow ((,class (:foreground "#638ea6" :background ,bg1))))
        `(term-color-magenta ((,class (:foreground "#646496" :background ,bg1))))
        `(term-color-cyan ((,class (:foreground ,success2 :background ,bg1))))
        ...
        `(helm-ff-executable ((,class (:foreground ,success3 :background ,bg1 :weight normal))))
