...
;; Created with ThemeCreator, https://github.com/mswift42/themecreator.
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'custom-dark
      ...
      `(show-paren-match-face ((,class (:foreground ,fg1 :background ,success3))))
      `(show-paren-mismatch-face ((,class (:foreground ,fg1 :background ,warning))))
      ...
      `(spaceline-flycheck-error ((,class (:foreground ,warning))))
      `(spaceline-flycheck-warning ((,class (:foreground ,warning2))))
      `(spaceline-flycheck-info ((,class (:foreground ,success))))
      ...
      `(term-color-red ((,class (:foreground ,warning :background ,bg1))))
      `(term-color-green ((,class (:foreground ,success2 :background ,bg1))))
      ...
      `(helm-ff-executable ((,class (:foreground ,success2 :background ,bg1 :weight normal))))
      ...
      `(company-tooltop-annotation ((,class (:foreground "#8787d7"))))
      ...
      `(js2-error ((,class (:foreground ,warning))))
      `(js2-warning ((,class (:foreground ,warning2))))
